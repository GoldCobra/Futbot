...
const LEGACY_RANK_ROLE_IDS = Object.freeze([
    ROLES.MEGASTRIKER,
    ROLES.LEGEND,
    ROLES.SUPERSTAR,
    ROLES.PROFESSIONAL,
...
module.exports = {
    GAME_TYPES,VOD_SUBMISSION_LINK, START_GG_VIDEOGAME_IDS_TO_GAME,GAME_TO_STAFF,ROLES,LEGACY_RANK_ROLE_IDS,PLAYER_ROLES, GUILD_ID, CHANNELS, RESTRICTED_COMMANDS, 
