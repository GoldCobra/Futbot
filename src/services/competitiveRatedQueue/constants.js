...
const MSC_RATED_ISSUE_SUPPORT_CHANNEL_ID = '1509130945003913246';
const SMS_RATED_ISSUE_SUPPORT_CHANNEL_ID = '1509131001161453628';
const MSBL_RATED_ISSUE_SUPPORT_CHANNEL_ID = '1509130895125250098';
const RATED_ISSUE_SUPPORT_CHANNEL_BY_GAME_TYPE = {
    MSC: MSC_RATED_ISSUE_SUPPORT_CHANNEL_ID,
    SMS: SMS_RATED_ISSUE_SUPPORT_CHANNEL_ID,
    MSBL: MSBL_RATED_ISSUE_SUPPORT_CHANNEL_ID
};
...
const RATED_RUNTIME_LOG_RETENTION_MS = 7 * 24 * 60 * 60 * 1000;
const RATED_RUNTIME_LOG_CLEANUP_INTERVAL_MS = 24 * 60 * 60 * 1000;
const RATED_RUNTIME_LOG_MAX_MESSAGE_LENGTH = 1900;
const RATED_RUNTIME_LOG_CLEANUP_FETCH_LIMIT = 100;
const COMPLETED_THREAD_CLOSE_DELAY_MS = 10 * 60_000;
const REMATCH_CONFIRM_TIMEOUT_MS = 5 * 60_000;
...
module.exports = {
    ...
    MSBL_RATED_ISSUE_SUPPORT_CHANNEL_ID,
    MSC_RATED_ISSUE_SUPPORT_CHANNEL_ID,
    SMS_RATED_ISSUE_SUPPORT_CHANNEL_ID,
